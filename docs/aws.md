...
This tutorial explains how to compile any Spatial application and run it on the Amazon F1.
It is not specific to applications created through the Spatial Multiverse.
...
* An installation of Spatial as described in the [installation tutorial](./installation.md)
...
If compiling from a front-end framework like TensorFlow, the script `dnn_to_spatial.py` will print the above command for you to run.
